...
import IntermediateCertification.Task4.Score;

public class determineWinner {

private determineWinner(String userChoice, String computerChoice) {// Метод для определения победителя
...
//            return "пользователь";// Победа пользователя
//        } else {
//            return "компьютер";// Победа компьютера
//        }
    ...
    if (userChoice.equals(computerChoice)) {
        ...
        System.out.println("Вы выиграли раунд. Всего очков у вас: " + userScore + " !!!");
    } else {
