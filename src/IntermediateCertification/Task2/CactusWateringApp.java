...
public class CactusWateringApp {

    public static void main(String[] args) {
        String lastWatered = "2025-04-14"; // Пример даты последнего полива
        CactusWateringScheduler scheduler = new CactusWateringScheduler(lastWatered);
